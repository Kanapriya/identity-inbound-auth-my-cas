...
public class SAMLSpInitRequest extends SAMLIdentityRequest {
    ...
    public String getSamlRequest() {
        if(this.getParameter(CASSSOConstants.SAML_REQUEST) != null) {
            return this.getParameter(CASSSOConstants.SAML_REQUEST);
        } else {
            try {
                return CASSSOUtil.getParameterFromQueryString(this.getQueryString(), CASSSOConstants.SAML_REQUEST);
