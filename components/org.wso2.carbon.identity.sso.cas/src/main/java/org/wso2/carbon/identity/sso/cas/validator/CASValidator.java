...
public abstract class CASValidator extends AbstractIdentityHandler {
     ...
     * @return
     */
    public abstract boolean validateRequest(CASMessageContext messageContext) throws IdentityException, IOException;
}
